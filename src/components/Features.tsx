...
const Features = () => {
  return (
    <section className="max-w-[70rem] m-auto mb-[1.5rem] mt-[3rem] px-5">
      <div className="grid md:grid-cols-3 sm:grid-cols-2">
        {/* --------- */}
        <div className="featrues-box-shadow flex justify-around items-center w-auto relative mb-[1.5rem] mr-2 p-3 border-[1px] border-[#e5e5e5] rounded-2xl">
          <div className="w-12">
            <svg
          ...
          <div>
            <h4 className="text-[.87rem] font-bold text-[#252a31] mb-2">
              رزرواسیون 24 ساعته
            </h4>
            <p className="text-[0.75rem] font-normal text-[#888888] ">
              خدمات آنلاین در تمام روز های هفته
            </p>
          </div>
        </div>
        {/* --------- */}
